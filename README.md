Command Line Parser Library 2.0.8.0 pre-release for CLR.
===
...
---
  ...
  - Map command line arguments to sequences (``IEnumerable<T>``), enum or standard scalar types (including ``Nullable<T>``).
